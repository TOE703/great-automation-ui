...
from pages.international.international_contact_investment_page import InternationalContactInvestmentPage
from pages.international.international_contact_investment_success_page import InternationalContactInvestmentSuccessPage


# no raw selenium or direct interaction with selenium api should be in a test - https://seleniumjava.com/2016/05/08/do-not-use-webdriver-apis-in-the-test-script/
