...
class TestHelper:
    ...
    # these methods aren't exactly 100% necessary but allow us to control waits in one place instead of having waits littered throughout and potentially compounding
    # or controls/condenses more complex setup like Selects
